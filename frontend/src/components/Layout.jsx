...
export default function Layout() {
    ...
    return (<div style={{ fontFamily: 'sans-serif', minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#121212' }}>
      <header style={{ background: '#173a29', color: '#fff', padding: '0 1.5rem', display: 'flex', alignItems: 'center', gap: '2rem', height: '56px', borderBottom: '1px solid #0d2318' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <button onClick={handleLogout} style={{ background: 'transparent', border: '1px solid #74b49b', color: '#d8f3dc', padding: '4px 12px', cursor: 'pointer', borderRadius: '4px', fontSize: '0.85rem' }}>
            Sign out
          </button>
        </div>
      </header>
